 ...
 */
public class ProfilesDashboard extends javax.swing.JFrame {
    ...
    String fname,email;
    public ProfilesDashboard(String name,String email ) {
    ...
    public void addRowDataToTable(){
        ...
        List<UserIdentity> studentList = dao.retrieveUser(email); 
        
        for(UserIdentity theUser : studentList){
  ...
  public static boolean isInvalidEmail(String email){
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if(fNameTxt.getText().trim().isEmpty()){
            ...
            //creating Object of the model class
                  ...
                  UserIdentityDao dao = new UserIdentityDao();
                  Integer rowsAffected = dao.updateUser(theUser); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfilesDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfilesDashboard("","").setVisible(true);
            }
        });
    }
