...
public class QuizCrudOp extends javax.swing.JFrame {
    ...
    String fname,email;
    public QuizCrudOp(String name,String email) {
        initComponents();
        this.fname = name;
        this.email = email;
    ...
    public void addRowDataToTable(){
        ...
        List<Questions> questionList = dao.fetchQuestion();
        
        for(Questions theQuestions : questionList){
            tableModel.addRow(new Object[]{
            
                theQuestions.getCourseId(),
                theQuestions.getQId(),
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if(courseIdTxt.getText().trim().isEmpty()){
            ...
            JOptionPane.showMessageDialog(this, "The Question ID are required");
        }else if(QuestionTxt.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(this, "The Question Text field is required");
            ...
            JOptionPane.showMessageDialog(this, "Choice4 field is required");
                ...
                int id = Integer.parseInt(courseIdTxt.getText());
                theQuestions.setQId(id);
                               

                //creating an object of dao class
                QuestionsDao dao = new QuestionsDao();
                Integer rowsAffected = dao.deleteQuestion(theQuestions);
                ...
                if(rowsAffected != null){
                    ...
                    JOptionPane.showMessageDialog(this, "Question not Deleted");
                }
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if(courseIdTxt.getText().trim().isEmpty()){
            ...
            JOptionPane.showMessageDialog(this, "Choice4 field is required");
                ...
                theQuestions.setCourseId(courseIdTxt.getText());
                theQuestions.setQId(id);
                ...
                //creating an object of dao class
                QuestionsDao dao = new QuestionsDao();
                Integer rowsAffected = dao.updateQuestions(theQuestions);
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
       ...
       if(courseIdTxt.getText().trim().isEmpty()){
            ...
            JOptionPane.showMessageDialog(this, "Choice4 field is required");
                ...
                //creating an object of dao class
                QuestionsDao dao = new QuestionsDao();
                Integer rowsAffected = dao.registerQuestion(theQuestions);
    ...
    private void refreshBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshBtnActionPerformed
        // TODO add your handling code here:
                    ...
                    questionIdTxt.setText("");
                    questionIdTxt.setEditable(true);
                    QuestionTxt.setText("");
                    cATxt.setText("");
                    choice1Txt.setText("");
                    choice2Txt.setText("");
