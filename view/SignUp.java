...
//        char[] repasswordChars = reTypePasswordTxt.getPassword();
//        String password = new String(passwordChars).trim();
//        String repassword = new String(repasswordChars).trim();
//        boolean isEmpty = password.isEmpty();
//        boolean IsEmpty = repassword.isEmpty();
        ...
        if(nameTxt.getText().trim().isEmpty()){
            ...
            //creating Object of the model class
                  ...
                  theUser.setFullName(nameTxt.getText());
                  ...
                  Integer rowsAffected = dao.userSignUp(theUser); 
