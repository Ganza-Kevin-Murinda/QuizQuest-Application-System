...
public class MessageDashboard extends javax.swing.JFrame {
    ...
    String fname,email;
    public MessageDashboard(String name,String email) {
    ...
    public void addRowDataToTable(){
        ...
        List<Message> messageList = dao.retrieveAllMessage();
        
        for(Message theMessage : messageList){
            tableModel.addRow(new Object[]{
            
                theMessage.getSenderName(),
                theMessage.getFeedback()
            });
        }
    ...
    private void initComponents() {
        ...
        markAsReadBtn.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
